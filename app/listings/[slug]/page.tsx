...
import {
  Bed, Bath, Square, Calendar, Tag, Home, Phone, Mail, ArrowLeft, Check,
} from 'lucide-react';
...
/**
 * Metadata per listing page
 * NOTE: params is typed as a Promise in newer Next.js types; await it.
 */
...
/**
 * Listing detail page
 * NOTE: params is a Promise here as well; await it to get the slug.
 */
      ...
      <main id="main-content" className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center justify-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm"
            >
